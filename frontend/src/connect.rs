...
pub fn Connect() -> Element {
    ...
    rsx! {
        div { class: "flex flex-col h-screen items-center justify-center",
            ...
            input {
                class: "placeholder:text-center my-3 items-center justify-center w-9/12 px-8 py-3 text-lg font-bold text-gray-900 transition-all duration-200 bg-gray-100 border-2 border-gray-900 md:w-5/12 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900",
